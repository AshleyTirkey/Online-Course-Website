	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Learn-io</h1>
			</div>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Ashley Tirkey</h4>
									<h4 class="team-member-designation">Co-Developer</h4>
							...
							<div class="team-member text-center">
								<img src="img/user.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Hexa</h4>
									<h4 class="team-member-designation">Co-Developer</h4>
									<ul class="social-list">
